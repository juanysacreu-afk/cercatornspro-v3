      ...
      {organizeType === OrganizeType.Comparador ? (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <CompareInputSlot label="Primer Torn" value={turn1Id} onChange={setTurn1Id} data={turn1Data} nowMin={nowMin} getSegments={getSegments} onClear={() => { setTurn1Id(''); setTurn1Data(null); }} selectedServei={selectedServei} />
            <CompareInputSlot label="Segon Torn" value={turn2Id} onChange={setTurn2Id} data={turn2Data} nowMin={nowMin} getSegments={getSegments} onClear={() => { setTurn2Id(''); setTurn2Data(null); }} selectedServei={selectedServei} />
          </div>
...
const CompareInputSlot = ({ label, value, onChange, data, onClear, nowMin, getSegments, selectedServei }: { label: string, value: string, onChange: (v: string) => void, data: any, onClear: () => void, nowMin: number, getSegments: (t: any) => any[], selectedServei: string }) => {
