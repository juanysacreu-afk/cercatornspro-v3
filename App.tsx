          ...
          <div className="flex items-center justify-between h-20 sm:h-24">
            ...
            >
              ...
              <span className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                <span className="text-gray-800 dark:text-white transition-colors duration-300">Cerca</span>
            ...
            <div className="md:hidden flex items-center gap-2">
              <button
                onClick={() => setIsDarkMode(!isDarkMode)}
                className="p-2 rounded-lg text-gray-700 dark:text-gray-400 hover:bg-black/5 dark:hover:bg-white/10 transition-colors"
              >
                {isDarkMode ? <Moon size={24} /> : <Sun size={24} />}
              </button>
              <button
                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                className="p-2 rounded-lg text-gray-700 dark:text-gray-400 hover:bg-black/5 dark:hover:bg-white/10 transition-transform active:scale-90"
              >
